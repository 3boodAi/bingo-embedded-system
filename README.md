...
Physical Bingo arcade console with a browser lobby, an Arduino Uno hardware controller, and an ESP32U Wi-Fi bridge. The lobby is configured for 3 players.
...
The player count is controlled by `MAX_PLAYERS`. It is currently set to `3` in `render.yaml`.
